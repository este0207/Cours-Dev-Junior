...
- **Statut Spécial** : Ciblez spécifiquement la carte qui possède l'attribut `data-level="beginner"`. Changez sa bordure en `2px solid #007bff` (bleu) et donnez-lui un fond beige.
...
- **Navigation** : Ajoutez une marge de `20px` entre chaque élément de liste `<li>` dans votre menu de navigation (`#menu`).
